...
function calc() {
  ...
  function calcTotal() {
    ...
    if (gender === 'female') {
      ...
      var _bmr = 88.36 + 13.4 * weight + 4.8 * height - 5.7 * age;

      result.textContent = Math.round(_bmr * ratio);
    }
  } // height = 180;
  // weight = 80;
  // age = 37;
...
/* harmony import */ var _modal__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./modal */ "./js/modules/modal.js");
...
function forms(formsSelector, modalSelector, modalTimerId) {
  ...
  function _postData() {
    _postData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(form) {
            ...
            case 0:
              form.addEventListener('submit', /*#__PURE__*/function () {
                var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
                  var statusMessage, formData, object, url, res;
  ...
  function showThanksModal(message) {
    ...
    (0,_modal__WEBPACK_IMPORTED_MODULE_18__.openModal)(modalSelector, modalTimerId);
...
function modal(modalSelector, triggerSelector, modalTimerId) {
  ...
  var modalCloseBtn = document.querySelector('[data-close]'); // console.log("modal", modal);
  ...
  function showModalByScroll() {
    ...
    var _document$documentEle = document.documentElement,
        ...
        scrollHeight = _document$documentEle.scrollHeight; // const pageYOffset = window.pageYOffset;
...
function timer(timerSelector, deadline) {
  ...
  function getTimeRemaining(endtime) {
    var total = Date.parse(endtime) - Date.parse(new Date()); //console.log(total / 1000 / 60 / 60 / 24);
  ...
  function setClock(selector, endtime) {
    ...
    var timeIntervalID = setInterval(updateClock, 1000);
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_2__["default"])('.timer', '2022-10-20');
